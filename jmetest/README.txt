...
This is the readme for jmetest, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Jmetest) > Ok.
...
- To run the project find Jmetest.java (which will be in under src/main/java/jmetest) and right click > Run 'Jmetest'
